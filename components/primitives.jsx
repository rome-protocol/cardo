...
//
// Ported from designer's V3 delivery (src/primitives.jsx). The visual layer
// is byte-preserved from the designer's file; only module-system seams
// were changed (imports replace `/* global React */ var {...} = React;`,
// and ES exports replace `Object.assign(window, {...})`).
  ...
  return (
    <header className="nav">
      <div className="nav-inner">
        ...
        <a href="#/test-index" className="nav-link" data-active={route === "/test-index" ? "true" : undefined}
           onClick={(e) => { e.preventDefault(); onNav("/test-index"); }}
           style={{ fontSize: 13, color: "var(--fg2)", marginRight: 12 }}>Test index</a>
...
// Expose — every top-level const / function used by screen files.
export {
  Roman,
  Eyebrow,
  Logomark,
